...
images: 'https://pbs.twimg.com/media/G-NPCDAWQAAPANv.jpg'
---
...
> **tl;dr I **built a starter template that's designed specifically for AI coding agents. Clone it, paste one prompt into Claude Code, and start building. The repo handles all the complexity so you can focus on describing what you want.
...
The starter template I'm sharing does exactly that. It's a Farcaster mini-app with an Arbitrum smart contract, and it's architected so that AI agents can modify it without breaking things.
...
- Collectibles tied to moments. For example, near the end of 2025, I put out an Arbitrum Unwrapped mini-app that minted your year on Arbitrum as a custom NFT.
...
The repo is at github.com/hummusonrails/farcaster-arbitrum-miniapp-starter. The documentation is written for AI agents, but it's readable by humans too if you want to understand what's happening under the hood.
